  ...
  export default {
    ...
    data() {
      return {
        ...
        dataType:'workorder',
        tableInfo: [
          {prop: 'work_list_NO',label: '工令號', type: 'number', necessary :'Y'},
          {prop: 'Part_NO',label: '料號', type: 'input', necessary :'Y'},
          {prop: 'VER',label: '版次', type: 'input', necessary :'Y'},
          {prop: 'product_name',label: '品名', type: 'input', necessary :'N'},
          {prop: 'machine_NO',label: '機台號', type: 'select', necessary :'Y'},
          {prop: 'machine_ton',label: '噸位', type: 'number', necessary :'Y'},
          {prop: 'plastic_Part_NO',label: '塑膠料號', type: 'input', necessary :'N'},
          {prop: 'plastic_color',label: '當前顏色', type: 'select', necessary :'N'},
          {prop: 'mold_NO',label: '模號', type: 'select', necessary :'Y'},
          {prop: 'plan_number',label: '數量', type: 'number', necessary :'Y'},
          {prop: 'mold_Serial',label: '模序', type: 'input', necessary :'Y'},
          {prop: 'mold_hole',label: '模穴數', type: 'number', necessary :'Y'},
          {prop: 'machine_CT',label: '標準週期', type: 'number', necessary :'N'},
          {prop: 'UPH',label: 'UPH', type: 'number', necessary :'N'},
          {prop: 'mold_position',label: '模具儲位', type: 'input', necessary :'N'},
          {prop: 'plan_work_time',label: '計畫工時', type: 'number', necessary :'Y'},
          {prop: 'plan_s_date',label: '預計開始日期', type: 'date2', necessary :'Y'},
          {prop: 'plan_e_date',label: '預計結束日期', type: 'date2', necessary :'Y'},
          {prop: 'plan_s_time',label: '預計開始時間', type: 'time', necessary :'Y'},
          {prop: 'plan_e_time',label: '預計結束時間', type: 'time', necessary :'Y'},
          {prop: 'person_in_charge',label: '負責人', type: 'input', necessary :'N'}
        ],
        data_detail: {
          pruduct_total: 0,
          pruduct_now: 0,
