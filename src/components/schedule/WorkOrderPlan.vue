  ...
  export default {
    ...
    data() {
      return {
        ...
        dataType:'workorder',
        tableInfo: [
          {prop: 'work_list_NO',label: '工令號', type: 'input_number'},
          {prop: 'machine_ton',label: '噸位', type: 'input_number'},
          {prop: 'machine_NO',label: '機台號', type: 'select'},
          {prop: 'plastic_color',label: '當前顏色', type: 'input'},
          {prop: 'plan_s_date',label: '預計開始日期', type: 'date2'},
          {prop: 'plan_e_date',label: '預計結束日期', type: 'date2'},
          {prop: 'plan_s_time',label: '預計開始時間', type: 'time'},
          {prop: 'plan_e_time',label: '預計結束時間', type: 'time'},
          {prop: 'product_name',label: '品名', type: 'input'},
          {prop: 'Part_NO',label: '料號', type: 'input'},
          {prop: 'plastic_Part_NO',label: '塑膠料號', type: 'input'},
          {prop: 'VER',label: '版次', type: 'input'},
          {prop: 'plan_number',label: '數量', type: 'input_number'},
          {prop: 'mold_NO',label: '模號', type: 'input'},
          {prop: 'mold_Serial',label: '模序', type: 'input'},
          {prop: 'mold_hole',label: '模穴數', type: 'input_number'},
          {prop: 'mold_position',label: '模具儲位', type: 'input'},
          {prop: 'plan_work_time',label: '計畫工時', type: 'input_number'},
          {prop: 'machine_CT',label: '標準週期', type: 'input_number'}
        ],
        data_detail: {
          pruduct_total: 0,
          pruduct_now: 0,
